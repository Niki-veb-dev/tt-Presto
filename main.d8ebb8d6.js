...
var slider = function slider() {
  ...
  var left = document.querySelector('.carousel__button--left');
  var right = document.querySelector('.carousel__button--right');
  ...
  var add = function add() {
    return slides[offSet].classList.add('carousel__slide--active');
  };

  var remove = function remove() {
    return slides[offSet].classList.remove('carousel__slide--active');
  };
};
...
var selectEye = function selectEye() {
  var mainSelect = document.querySelectorAll('.features__main > div');
  var descrSelect = document.querySelectorAll('.features__main > aside'); // don't ever do that

  mainSelect.forEach(function (item, i) {
    item.addEventListener('click', function () {
      descrSelect.forEach(function (descr, index) {
        if (index !== i) {
